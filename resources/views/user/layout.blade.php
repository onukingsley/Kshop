...
<!-- Mirrored from cartzilla.createx.studio/shop-single-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Apr 2022 16:13:10 GMT -->
...
<head>
    ...
    <link rel="stylesheet" media="screen" href="{{asset('user/vendor/drift-zoom/dist/drift-basic.min.css')}}"/>
    <link rel="stylesheet" media="screen" href="{{asset('user/vendor/lightgallery.js/dist/css/lightgallery.min.css')}}"/>
            ...
            <div class="navbar navbar-expand-lg navbar-light">
                <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="index.html"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="index.html"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
                    ...
                    <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                        ...
                        <div class="navbar-tool dropdown ms-3"><a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="/cart"><span class="navbar-tool-label">4</span><i class="navbar-tool-icon ci-cart"></i></a><a class="navbar-tool-text" href="/cart"><small>My Cart</small>$265.00</a>
                            <!-- Cart dropdown-->
                            <div class="dropdown-menu dropdown-menu-end">
                                <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                                    <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                                        ...
                                        <div class="widget-cart-item pb-2 border-bottom">
                                            <form action="/cart/{{$cart->id}}/delete" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn-close text-danger" type="submit" aria-label="Remove"><span aria-hidden="true">&times;</span></button>


                                            </form>


                                            <div class="d-flex align-items-center"><a class="flex-shrink-0" href="shop-single-v1.html"><img src="{{$cart->image? '/storage/'.$cart->image: asset('user/img/shop/cart/widget/01.jpg')}}" width="64" alt="Product"></a>
                                                <div class="ps-2">
                                                    <h6 class="widget-product-title"><a href="shop-single-v1.html">{{$cart->product_title}}</a></h6>
                                    ...
                                    </div><a class="btn btn-primary btn-sm d-block w-100" href="/cart"><i class="ci-card me-2 fs-base align-middle"></i>Checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="{{asset('user/vendor/drift-zoom/dist/Drift.min.js')}}"></script>
<script src="{{asset('user/vendor/lightgallery.js/dist/js/lightgallery.min.js')}}"></script>
<script src="{{asset('user/vendor/lg-video.js/dist/lg-video.min.js')}}"></script>
<!-- Main theme script-->
<script src="{{asset('user/js/theme.min.js')}}"></script>
</body>

<!-- Mirrored from cartzilla.createx.studio/shop-single-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Apr 2022 16:13:13 GMT -->
</html>
